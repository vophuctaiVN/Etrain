...
INSERT INTO `gram_topics` (`Title`, `Level`, `ImageURL`, `Description`) VALUES ("Present perfect tense","Elementary","https://www.english-learn-online.com/wp-content/uploads/present-perfect-tense-696x373.jpg","Present perfect tense is one of the commonly used verb tenses in English. It describes unfinished actions, experiences or actions without a definite time in the past");
