...
class CheckoutView extends Component {
  ...
  handleAddressSelect(fatherID, level) {
    if (0 === fatherID) {
      if ("Tỉnh/Thành" === level) this.setState({ provinces: [] });
      if ("Quận/Huyện" === level) this.setState({ districts: [] });
      if ("Phường/Xã" === level) this.setState({ communes: [] });
      return;
    }
    window
            ...
            <div className="col-xl-4">
              <div className="row mx-0">
                <div className="cart-detail cart-total ftco-bg-dark p-3 p-md-4 col-xl-12 col-md-6">
                  ...
                  <p className="d-flex">
                    <span>Subtotal</span>
                    <span>{this.props.cart.subtotal} Đ</span>
                  </p>
                  <p className="d-flex">
                    <span>Delivery</span>
                    <span>{this.props.cart.delivery} Đ</span>
                  </p>
                  <p className="d-flex">
                    <span>Discount</span>
                  ...
                  <p className="d-flex total-price">
                    <span>Total</span>
                    <span>{this.props.cart.total} Đ</span>
                  </p>
                </div>
