...
function ReviewCard(props) {
  ...
  var date = Date.parse(props.firstDate.toString());
  const daysAgo = Math.floor(Math.abs(dateNow - date) / (1000 * 60 * 60 * 24)); //Math floor khi đủ 24 giờ mới tính, nhưng theo mysql qua qua ngày là tính 1 (qua 12h)

  const dateObj = new Date(props.firstDate);
            ...
            <div className="bt_bb_schedule_content">
              ...
              >
                <div className="bt_bb_schedule_day">
                  <span className="bt_bb_schedule_week_day">release date</span>
                </div>
              ...
              >
                ...
                <div className="bt_bb_schedule_time">
                  <span className="bt_bb_schedule_hours">{props.times}</span>
                </div>
              </div>
