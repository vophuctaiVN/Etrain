          ...
          <div className="col-md-6 col-lg-6">
            <div className="learning_member_text">
              ...
              <p>
                ...
                everyday. Check it whenever and wherever you want. Don't be shy
                with your mistakes. Study more and more. There is no faster way
              ...
              <div className="row">
                <div className="col-sm-6 col-md-12 col-lg-6">
                  <div className="learning_member_text_iner">
                    ...
                    <p>
                      You can study with any devices having internet connection.
                    </p>
                  </div>
                </div>
                <div className="col-sm-6 col-md-12 col-lg-6">
